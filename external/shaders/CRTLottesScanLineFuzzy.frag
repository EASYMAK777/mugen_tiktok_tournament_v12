...
#define HARD_PIX -2.0 // Hardness of pixels in scanline. -2.0 = soft, -4.0 = hard
#define WARP vec2(0.0,0.0) // Display warp.// 0.0 = none // 1.0/8.0 = extreme
#define MASK_DARK 0.6 // Amount of shadow mask.
#define MASK_LIGHT 1.25 // Amount of shadow mask.
...
float Scan(vec2 pos, float off) {
    ...
    return Gaus(dst + off, hardScan); //original is just dst + off, hardScan
}
